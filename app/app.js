...
import PPINOTElementFactory from './PPINOT-modeler/PPINOT/PPINOTElementFactory.js';
import PPINOTContextPadProvider from './PPINOT-modeler/PPINOT/PPINOTContextPadProvider.js';
...
function createNewDiagram() {
    modeler.clear()
        // From now on, bpmnjs uses promises, so try catch its necessary
    try {
